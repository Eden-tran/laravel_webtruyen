                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-group d-inline-block">
                                                            ...
                                                            <select class="form-select d-inline ml-1" style="width:62%"
                                                                ...
                                                                <option selected value=NULL>Hãy chọn phạm vi truy cập </option>
                                                                <option value="1"
                                                                    @php
$arr=old('role', $groupRoleArr);
if ($arr && array_key_exists($item->name, $arr) && array_key_exists('Scope',$arr[$item->name])) {
                                                                    if ($arr[$item->name]['Scope'] == 1 ) {
                                                                            echo 'selected';
                                                                        }
                                                                } @endphp>
                                                                    Tất cả</option>
